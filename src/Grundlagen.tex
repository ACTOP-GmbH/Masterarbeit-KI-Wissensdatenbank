...
Im Rahmen dieser Arbeit spielt die Unterscheidung zwischen CPU- und GPU-Inferenz eine zentrale Rolle, da sie direkt bestimmt, ob ein Modell effizient auf Consumer-Hardware betrieben werden kann (vgl. Abschnitt~\ref{subsubsec:cpu-vs-gpu}).
