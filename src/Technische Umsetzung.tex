...
class DefaultMultiLLM(LLM):
    def __init__(
        ...
        # konfigurierbares Timeout über .env / QA_TIMEOUT
        self._timeout = timeout or QA_TIMEOUT
...
\begin{listing}[H]
    \begin{minted}[fontsize=\footnotesize, linenos]{python}
        ...
        # Vereinfachte, robustere Variante:
        # Timeout wird nicht mehr über QA_TIMEOUT oder .env gesteuert,
        # sondern explizit im Code festgelegt.
        self._timeout = 600
        if timeout is None:
