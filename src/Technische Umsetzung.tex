...
Gemäß der in Kapitel~\ref{sec:subsubsec:zielarchitektur-modularitaet-entkopplung} beschriebenen Zielarchitektur fiel die Wahl auf die Open-Source-Plattform \textit{Onyx} (ehemals \textit{Danswer}) als technisches Fundament.
