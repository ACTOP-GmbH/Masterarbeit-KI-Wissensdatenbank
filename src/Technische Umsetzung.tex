...
\begin{figure}[H]
    ...
    \caption{Chunking-Prozess in Onyx (Quelle: Eigene Darstellung basierend auf Onyx-Dokumentation~\cite{onyx_data_flows})}
...
\begin{figure}[H]
    ...
    \caption{RAG-Anfrageprozess in Onyx (Quelle: Eigene Darstellung basierend auf Onyx-Dokumentation~\cite{onyx_data_flows})}
