...
\begin{itemize}
    \item \emph{kurze Anfragen:} einfache Fragen ohne umfangreichen Kontext; typische Antwortzeit im Bereich von 1--10 Sekunden,
    \item \emph{mittlere Anfragen:} fachliche Fragen mit mehreren relevanten Chunks; Antwortzeit im Bereich von ca.\ 5-25 Sekunden,
    \item \emph{komplexe Anfragen:} lange, mehrteilige Fragen oder Fragen mit vielen fundenden Kontextpassagen; Antwortzeit gelegentlich oberhalb von 10 Sekunden.
\end{itemize}
