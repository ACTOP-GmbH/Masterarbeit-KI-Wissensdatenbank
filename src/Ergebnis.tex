...
Die in der technischen Umsetzung beschriebene abschnittsorientierte Chunking-Strategie mit Token-Limits und Overlap ist eine plausible Antwort auf dieses Spannungsfeld.
Akzeptanzseitig ist insbesondere relevant, dass Antworten konsistent und reproduzierbar wirken.
...
Die Datenschutzaspekte wurden in der Architektur stringent adressiert, indem alle Komponenten lokal betrieben werden.
...
Parallel dazu empfiehlt sich eine systematische Optimierung der Retrieval-Pipeline: Kalibrierung von Top-$k$, Chunk-Größen, Overlap, Hybrid Search und ggf.\ Re-Ranking anhand eines festen Fragenkatalogs.
